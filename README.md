...
# Alexandre Martins de Freitas (alexdkk / AMF)

🚀 Software Engineer | Systems Architect | Algorithm Designer  
📍 Portugal  

---

## 🧠 About Me
I design and build high-performance systems, mathematical structures, and scalable backend architectures.

Creator of:
- **AMF Hash** – structured deterministic hashing algorithm
- **AMF Division** – quotient–remainder representation system
- **Matrix Framework** – Java-based game and server architecture
...
- Low-level Optimization (Java / C)
- Backend Infrastructure

---

## 🔬 Research & Innovation
Focused on building new computational structures and improving performance beyond traditional approaches.

Current work:
- AMF Framework (math + systems)
- Hashing and data integrity systems
- Engine-level optimizations

---

## 📊 Investment
Technology-focused investor with 100%+ return over 2 years across 15+ companies.  
Building a tech-driven hedge fund.

---

## 🌐 Links
- LinkedIn: https://www.linkedin.com/in/alexandre-martins-de-freitas-457347328
- AMF Hash: https://github.com/martinsdefreitasalexandre/Amf-hash
